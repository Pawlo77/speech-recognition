...
\begin{description}
    ...
    \item[xLSTM (High-Capacity Recurrence):] Solves classical LSTM scalar bottlenecks by introducing matrix memory $C_t \in \mathbb{R}^{d \times d}$ \cite{beck2024xlstm}, providing a direct test of sequential tracking suitability.
